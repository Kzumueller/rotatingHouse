...
2,0,-1, 2,2,-1, -2,2,-1, -2,0,-1, /* back wall */
2,0, 1, 2,2, 1, -2,2, 1, -2,0, 1, /* front wall */
2,4,0, -2,4,0, 2.2,4,0, -2.2,4,0, /* top */
2.2,1.9,-1.1, -2.2,1.9,-1.1, 2.2,1.9,1.1, -2.2,1.9,1.1, /* edges of the roof */
1,0,0.5, 1.25,0,0.5, 1.25,0,0.25, 1,0,0.25, 1,4.5,0.5, 1.25,4.5,0.5, 1.25,4.5,0.25, 1,4.5,0.25 /* chimney */
};
...
void keyboardInput(unsigned char key, int x, int y) {
  switch(key) {
    case 'f':
      ...
      glutPostRedisplay();
      break;
    case 'w': rotateAroundCenter(15., HORIZONTAL); break;
    case 'a': rotateAroundCenter(-15., VERTICAL); break;
    case 's': rotateAroundCenter(-15., HORIZONTAL); break;
    case 'd': rotateAroundCenter(15., VERTICAL); break;
